...
function Header() {
  ...
  return (
      <header
        className={`flex fixed top-0 right-0 left-0 justify-center py-3 border-b-1 bg-[#252525] z-50 ${
          isScrolled ? " py-3 " : "bg-[#161616] py-3"
        }`}
      >
        <div className="container w-[1400px]">
          <nav className="text-white flex items-center justify-between text-md">
            ...
            <div
              className={`link-menu font-semibold z-50 transition-all duration-300 ease-in-out
              ${
                menuOpen
                  ? "fixed top-[4.5rem] left-0 right-0 w-full h-[calc(100vh-4.5rem)] flex flex-col items-center justify-start pt-20 gap-4 text-xl bg-[#0e0e0e]"
            ...
            <div
              className={`w-px h-5 mr-6 ml-6 bg-gray-600 ${
            ...
            >
              ...
              <a
                href="https://www.instagram.com/hikarizenka._/"
                target="_blank"
              >
